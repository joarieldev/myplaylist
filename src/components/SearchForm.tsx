    ...
    >
      ...
      <div className="relative w-full">
        ...
        <input
          ...
          className="w-full pl-11 pr-11 py-2 hover:bg-neutral-800/90 bg-neutral-900/90 rounded-full text-sm max-sm:font-semibold outline-none cursor-pointer transition-colors focus:ring-2 focus:ring-neutral-500/90"
        />
